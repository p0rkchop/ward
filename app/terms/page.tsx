...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-bold tracking-tight text-gray-900 mb-8">Terms &amp; Conditions</h1>
      ...
      <div className="prose prose-gray max-w-none space-y-6">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">4. User Roles and Responsibilities</h2>

          <h3 className="text-lg font-medium text-gray-800 mt-4 mb-2">Administrators</h3>
          <p className="text-gray-700 leading-relaxed">
          ...
          <h3 className="text-lg font-medium text-gray-800 mt-4 mb-2">Professionals</h3>
          <p className="text-gray-700 leading-relaxed">
          ...
          <h3 className="text-lg font-medium text-gray-800 mt-4 mb-2">Clients</h3>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">6. Appointment Policies</h2>
          <ul className="list-disc pl-6 text-gray-700 space-y-2 mt-2">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">7. SMS Communications</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">9. Disclaimer of Warranties</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">11. Account Termination</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">12. Changes to These Terms</h2>
          <p className="text-gray-700 leading-relaxed">
