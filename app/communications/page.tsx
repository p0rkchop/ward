...
export default function CommunicationsPolicyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-bold tracking-tight text-gray-900 mb-8">Communications Policy</h1>
      <p className="text-sm text-gray-500 mb-8">Last updated: February 27, 2026</p>

      <div className="prose prose-gray max-w-none space-y-6">
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">1. Consent to Receive Messages</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">2. Service-Related Messages Only</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">3. SMS Text Messages</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">4. Email Communications</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">5. Message Content</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">6. Your Responsibilities</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">7. Third-Party Messaging Providers</h2>
          <p className="text-gray-700 leading-relaxed">
