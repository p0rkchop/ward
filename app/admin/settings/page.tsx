  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-lg bg-white p-6 shadow">
          <h2 className="text-lg font-medium leading-6 text-gray-900">Database</h2>
          ...
          <div className="mt-4 space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Send email notifications for new bookings</p>
              </div>
              <input
                type="checkbox"
                defaultChecked
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Send SMS notifications for appointment reminders</p>
              </div>
              <input
                type="checkbox"
                defaultChecked
