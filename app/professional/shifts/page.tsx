    ...
    <div>
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-gray-900">My Shifts</h1>
        ...
        {upcomingShifts.length > 0 ? (
          ...
          <div className="rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
            <div className="mx-auto max-w-md">
              ...
              <h3 className="mt-4 text-lg font-medium text-gray-900">No upcoming shifts</h3>
      ...
      {pastShifts.length > 0 && (
        <div>
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-xl font-semibold text-gray-900">Past Shifts</h2>
