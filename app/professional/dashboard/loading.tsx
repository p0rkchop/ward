          ...
          <div className="space-y-4">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="flex items-center justify-between p-4 border border-gray-100 rounded-lg">
                ...
                <div className="h-8 w-20 bg-gray-100 dark:bg-gray-800 rounded animate-pulse"></div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="space-y-4">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="p-4 border border-gray-100 rounded-lg">
                ...
                <div className="h-3 w-48 bg-gray-100 dark:bg-gray-800 rounded animate-pulse mb-1"></div>
